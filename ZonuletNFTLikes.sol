// File: src/openzeppelin/utils/introspection/IERC165.sol
...
// File: src/contracts/ZonuletNFT.sol
...
// File: src/contracts/ZonuletNFTLikes.sol
...
contract ZonuletNFTLikes {
    ...
    function PacmanNFT(address _minter, uint256 _tokenId) public payable {
        ...
        nftPacmans[_tokenId].pacmans += 5;
        nftPacmans[_tokenId].nftId = _tokenId;
        pacmanisers[msg.sender].totalpacman += 5;
